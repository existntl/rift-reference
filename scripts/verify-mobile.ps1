...
& $compiler /nologo /target:exe "/out:$appRoot/MobileTests.exe" "/reference:$appRoot/RiftReference.exe" /reference:System.Windows.Forms.dll /reference:System.Drawing.dll (Join-Path $projectRoot 'tests/MobileTests.cs')
...
& $compiler /nologo /target:exe "/out:$appRoot/PostgameTests.exe" "/reference:$appRoot/RiftReference.exe" /reference:System.Windows.Forms.dll /reference:System.Drawing.dll /reference:System.Web.Extensions.dll (Join-Path $projectRoot 'tests/PostgameTests.cs')
