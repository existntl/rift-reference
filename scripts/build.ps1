...
$sourceNames = @('Core','App','DashboardNavigation','Pages','ReviewPage','HomeData','HomeDashboard','HomeOverview','DashboardAssets','RankHistory','Matchup','AudioCues','Updates','ReleaseSecurity','Mobile','Theme','PreferencesUi','PreferencesStore','Brand','Pregame','BuildPlanner','LoadoutEditor','Recommendations','RecommendationDashboard','Postgame','Overlay','OverlayVisuals','PanelLayout','StatsPanel','NativeOverlayBridge')
